...
defineSupportCode(function ({ Given, When, Then }) {
    ...
    Given(/^o pedido "(\d*)" cadastrado ao cliente "([^\"]*)" com "(\d*)" unidades de "([^\"]*)" possui um valor bruto de R$ "([^\"]*)" e recebeu um desconto de  R$ "([^\"]*)"$/, async (code, client, quant, produto, preco, desconto) => {
